 ...
 */
 ...
 fp= fopen("dmag2_input.txt","r");
 if ( fp == 0 ) {
    fprintf(stdout,"dmag2_input.txt not found!\n");
    return 1;
 }
 ...
 */
 ...
 /*
 Get radius (window size = 2*radius+1)
 */
 ...
 */
 ...
 fprintf(stdout,"gamma proximity = %g\n",gamma_p);
 ...
 */
 ...
 /*
 Get the disparity maps and the occlusion maps
 */

 fprintf(stdout,"Getting the disparity maps and occlusion maps ...\n");
 ...
 fprintf(stdout,"Getting the disparity maps and occlusion maps ... done.\n");
