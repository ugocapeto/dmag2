 ...
 */
 ...
 gamma_p_ds= gamma_p/(double)ds_factor;
 ...
 /*
 Get the disparity map 1 and the disparity map 2
 */
 ...
 fprintf(stdout,"Getting the disparity map for image 1 and image 2 ...\n");
 ...
 fprintf(stdout,"Getting the disparity map for image 1 and image 2 ... done.\n");
